...
import { LookupCombobox } from "./Components/LookupChoice";
import * as React from "react";

export class LookupChoice implements ComponentFramework.ReactControl<IInputs, IOutputs> {
    ...
    private renderControl(context: ComponentFramework.Context<IInputs>) : React.ReactElement {
		...
		const recordId = context.parameters.lookupControl.raw != null && context.parameters.lookupControl.raw.length > 0 
		? context.parameters.lookupControl.raw[0].id?.replace(/[{}]/g,"").toLowerCase()
		: '---'
